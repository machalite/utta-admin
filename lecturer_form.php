<?php
  //form for insert or update operation
	...
	if(!empty($_GET['id']))
	{
		...
		$text=$textUpdate." ".$textLecturer;

		// attempt select query execution
		$sql=mysqli_query($con,"SELECT id,code,name
			FROM lecturer WHERE id='$_GET[id]'");
		...
		$link="lecturer_func.php?&ops=2";
	}
	else
	{
		$text=$textAdd." ".$textLecturer;
		$id=null;
		$name=null;
		$code=null;

		$link="lecturer_func.php?&ops=1";
	}
		...
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<div class="x_panel">
					...
					<br />
						<!-- FORM -->
						<form name="lecturerForm" method="post"
